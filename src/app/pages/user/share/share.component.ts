...
export class SharePageComponent {
	...
	readonly title = computed(() =>
		this.kind() === 'profile'
			...
			: this.translateService.translate('Поділитися BodyCare')(),
	);

	readonly description = computed(() =>
		this.kind() === 'profile'
			? this.translateService.translate('Дайте людям відсканувати цей код, щоб відкрити мій профіль BodyCare.')()
			: this.translateService.translate('Відскануйте код, щоб приєднатися до BodyCare за кілька секунд.')(),
	);
